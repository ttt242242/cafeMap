...
class MemosControllerTest < ActionController::TestCase
  ...
  test "should create memo" do
    assert_difference('Memo.count') do
      post :create, memo: { address: @memo.address, description: @memo.description, latitude: @memo.latitude, longitude: @memo.longitude, title: @memo.title, user_id: @memo.user_id }
    end
  ...
  test "should update memo" do
    patch :update, id: @memo, memo: { address: @memo.address, description: @memo.description, latitude: @memo.latitude, longitude: @memo.longitude, title: @memo.title, user_id: @memo.user_id }
    assert_redirected_to memo_path(assigns(:memo))
  end
